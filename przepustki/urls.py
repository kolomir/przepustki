...
from .views import przepustki_dzis,wystaw_przepustke,edytuj_przepustke, usun_przepustke, przywroc_przepustke, \
                   ...
                   wystaw_przepustke_temp, edytuj_przepustke_temp, przepustki_dzis_temp, pracownik_szczegoly, pracownik_szczegoly_form
...
urlpatterns = [
    ...
    path('szczegoly/<int:id>/', pracownik_szczegoly, name='szczegoly'),
    path('szczegoly_form/', pracownik_szczegoly_form, name='szczegoly_form'),
